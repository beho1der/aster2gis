...
# Класс с параметрами для соединения с БД,также ключ для 2gis 
class calloutrec:
	DBHOST = 'localhost'
	DBUSER = 'voip'
	DBPASS = 'voip2voip'
	...
	def rosfirm_write(self,num,z): 
		...
		if len(y) == 0:
			...
			x = y[1] # тут вызывать функцию записи в БД!)
	...
	def main(self,num):
		...
		if cursor.fetchone() != None:
			...
			x = self.togis_write(num,0)  # Записи в базу 2gis!
